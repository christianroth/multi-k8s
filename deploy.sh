...
kubectl set image deployments/client-deployment client=christianroth/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=christianroth/multi-worker:$SHA
